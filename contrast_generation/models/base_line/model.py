...
from contrast_generation.losses.contrast_loss import (
    ContentContrastLoss, 
    TestContentContrastLoss
)
...
class BaseLine(pl.LightningModule):
    ...
    def __init__(self, 
        ...
        self.ae = models.ResUnetAE(self.resnet, ae_bridge_out_dims, "conv_transpose", ae_output_size)
        ...
        self.gan = models.ConstrastDCGAN(
